...
package talend_191203_01.tercer_job_0_1;
 ...
 * @status
 */
public class Tercer_job implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Tercer_job.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(Tercer_job.class);
	...
	private final String jobName = "Tercer_job";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_JZfSwBXMEeq_R_59Zh49mg", "0.1");
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Tercer_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TALEND_191203_01_Tercer_job = new byte[0];
		static byte[] commonByteArray_TALEND_191203_01_Tercer_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALEND_191203_01_Tercer_job.length) {
					if (length < 1024 && commonByteArray_TALEND_191203_01_Tercer_job.length == 0) {
						commonByteArray_TALEND_191203_01_Tercer_job = new byte[1024];
					} else {
						commonByteArray_TALEND_191203_01_Tercer_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALEND_191203_01_Tercer_job, 0, length);
				strReturn = new String(commonByteArray_TALEND_191203_01_Tercer_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND_191203_01_Tercer_job) {

				try {

					int length = 0;

					this.campo1 = readString(dis);
	...
	public void tFixedFlowInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "campo1", });
...
///////////////////////		
					...
					if (row1.campo1 != null) { //
						row_tLogRow_1[0] = String.valueOf(row1.campo1);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Tercer_job Tercer_jobClass = new Tercer_job();

		int exitCode = Tercer_jobClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Tercer_job' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Tercer_job' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Tercer_job.class.getClassLoader()
					.getResourceAsStream("talend_191203_01/tercer_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Tercer_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Tercer_job");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 47117 characters generated by Talend Cloud Big Data on the 4 de diciembre de
 * 2019 15:02:14 CET
 ************************************************************************************************/